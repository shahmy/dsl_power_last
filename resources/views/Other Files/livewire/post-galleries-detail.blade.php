<div>
    ...
    <x-modal id="post-galleries-modal" wire:model="showingModal">
        ...
        <table class="table table-borderless table-hover">
            <thead>
                <tr>
                    ...
                    <th class="text-left">
                        @lang('crud.post_galleries.inputs.project_id')
                    </th>
                    <th class="text-left">
                        @lang('crud.post_galleries.inputs.product_id')
                    </th>
                    <th class="text-left">
                        @lang('crud.post_galleries.inputs.name')
                    </th>
                    <th class="text-left">
                        @lang('crud.post_galleries.inputs.description')
                    </th>
                    <th class="text-left">
                        @lang('crud.post_galleries.inputs.status')
                    </th>
                    <th></th>
                </tr>
            </thead>
