<div>
    ...
    <x-modal id="project-galleries-modal" wire:model="showingModal">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div>
                    ...
                    <x-inputs.group class="col-sm-12">
                        <x-inputs.select
                            name="gallery.product_id"
                            label="Product"
                            wire:model="gallery.product_id"
                        >
        ...
        <table class="table table-borderless table-hover">
            <thead>
                <tr>
                    ...
                    <th class="text-left">
                        @lang('crud.project_galleries.inputs.post_id')
                    </th>
                    <th class="text-left">
                        @lang('crud.project_galleries.inputs.product_id')
                    </th>
                    <th class="text-left">
                        @lang('crud.project_galleries.inputs.name')
                    </th>
                    <th class="text-left">
                        @lang('crud.project_galleries.inputs.description')
                    </th>
                    <th class="text-left">
                        @lang('crud.project_galleries.inputs.status')
                    </th>
                    <th></th>
                </tr>
            </thead>
