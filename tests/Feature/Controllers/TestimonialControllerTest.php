...
class TestimonialControllerTest extends TestCase
{
     ...
     * @test
     */
    public function it_displays_index_view_with_testimonials()
    {
     ...
     * @test
     */
    public function it_displays_create_view_for_testimonial()
    {
     ...
     * @test
     */
    public function it_displays_show_view_for_testimonial()
    {
     ...
     * @test
     */
    public function it_displays_edit_view_for_testimonial()
    {
        $testimonial = Testimonial::factory()->create();
