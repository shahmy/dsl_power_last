...
use App\Filament\Resources\PartnerPageResource\Pages;

class PartnerPageResource extends Resource
{
    protected static ?string $model = PartnerPage::class;
    ...
    {
        return [
            'index' => Pages\ListPartnerPages::route('/'),
            'create' => Pages\CreatePartnerPage::route('/create'),
            'edit' => Pages\EditPartnerPage::route('/{record}/edit'),
        ];
    }
}
